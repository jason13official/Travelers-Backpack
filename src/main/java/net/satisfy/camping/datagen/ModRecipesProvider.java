...
import net.satisfy.camping.common.recipes.BackpackUpgradeRecipeJsonBuilder;
import net.satisfy.camping.common.recipes.ShapedBackpackRecipeJsonBuilder;
...
public class ModRecipesProvider extends FabricRecipeProvider
{
    ...
    public void generate(Consumer<RecipeJsonProvider> exporter)
    {
      /*  for(Item item : BACKPACKS)
        {
            //Tiers
            BackpackUpgradeRecipeJsonBuilder.create(Ingredient.ofItems(Items.LEATHER), Ingredient.ofStacks(createTieredStack(item, Tiers.LEATHER)), Ingredient.ofItems(ModItems.IRON_TIER_UPGRADE), RecipeCategory.TOOLS, item).criterion("has_iron_tier_upgrade", conditionsFromItem(ModItems.IRON_TIER_UPGRADE)).offerTo(exporter, Registries.ITEM.getKey(item.asItem()).getValue().getPath() + "_smithing_iron");
            BackpackUpgradeRecipeJsonBuilder.create(Ingredient.ofItems(Items.LEATHER), Ingredient.ofStacks(createTieredStack(item, Tiers.IRON)), Ingredient.ofItems(ModItems.GOLD_TIER_UPGRADE), RecipeCategory.TOOLS, item).criterion("has_gold_tier_upgrade", conditionsFromItem(ModItems.GOLD_TIER_UPGRADE)).offerTo(exporter, Registries.ITEM.getKey(item.asItem()).getValue().getPath() + "_smithing_gold");
            BackpackUpgradeRecipeJsonBuilder.create(Ingredient.ofItems(Items.LEATHER), Ingredient.ofStacks(createTieredStack(item, Tiers.GOLD)), Ingredient.ofItems(ModItems.DIAMOND_TIER_UPGRADE), RecipeCategory.TOOLS, item).criterion("has_diamond_tier_upgrade", conditionsFromItem(ModItems.DIAMOND_TIER_UPGRADE)).offerTo(exporter, Registries.ITEM.getKey(item.asItem()).getValue().getPath() + "_smithing_diamond");
            BackpackUpgradeRecipeJsonBuilder.create(Ingredient.ofItems(Items.LEATHER), Ingredient.ofStacks(createTieredStack(item, Tiers.DIAMOND)), Ingredient.ofItems(ModItems.NETHERITE_TIER_UPGRADE), RecipeCategory.TOOLS, item).criterion("has_netherite_tier_upgrade", conditionsFromItem(ModItems.NETHERITE_TIER_UPGRADE)).offerTo(exporter, Registries.ITEM.getKey(item.asItem()).getValue().getPath() + "_smithing_netherite");

            //Crafting upgrade
            BackpackUpgradeRecipeJsonBuilder.create(Ingredient.ofItems(Items.LEATHER), Ingredient.ofItems(item), Ingredient.ofItems(ModItems.CRAFTING_UPGRADE), RecipeCategory.TOOLS, item).criterion("has_crafting_upgrade", conditionsFromItem(ModItems.CRAFTING_UPGRADE)).offerTo(exporter, Registries.ITEM.getKey(item.asItem()).getValue().getPath() + "_smithing_crafting");
        } */
    ...
    public static void offerDyeableRecipes(Consumer<RecipeJsonProvider> exporter, List<Item> dyes, List<Item> dyeables, String group)
    {
