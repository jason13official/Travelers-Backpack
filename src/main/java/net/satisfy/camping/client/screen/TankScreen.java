...
public class TankScreen
{
    ...
    public List<Text> getTankTooltip()
    {
        ...
        String fluidName = !fluidVariant.isBlank() ? FluidVariantAttributes.getName(fluidVariant).getString() : I18n.translate("screen.camping.none");
        String fluidAmount = I18n.translate("screen.camping.empty");
