    ...
    void drawMouseoverTooltip(DrawContext context, int mouseX, int mouseY)
    {
        if(BackpackUtils.isShiftPressed())
        {
            if(isButtonHovered(mouseX, mouseY, Buttons.SORT))
            {
                ...
                list.add(Text.translatable("screen.camping.sort"));
            ...
            {
                List<Text> list = new ArrayList<>();
                list.add(Text.translatable("screen.camping.quick_stack"));
                list.add(Text.translatable("screen.camping.quick_stack_shift"));
            ...
            {
                List<Text> list = new ArrayList<>();
                list.add(Text.translatable("screen.camping.transfer_to_backpack"));
                list.add(Text.translatable("screen.camping.transfer_to_backpack_shift"));
            ...
            if(isButtonHovered(mouseX, mouseY, Buttons.TRANSFER_TO_PLAYER))
            {
                context.drawTooltip(screen.getTextRenderer(), Text.translatable("screen.camping.transfer_to_player"), mouseX, mouseY);
            }
        }
    }
