...
public class Reference
{
    ...
    //Translation Keys
    public static final String NO_BACKPACK = "action.camping.unequip_nobackpack";
    public static final String NO_SPACE = "action.camping.unequip_nospace";
    public static final String OTHER_BACKPACK = "action.camping.equip_otherbackpack";
    public static final String FAIL = "action.camping.equip_fail";
    public static final String DEPLOY = "action.camping.deploy_sleeping_bag";
